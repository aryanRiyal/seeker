...
const MyJobs = () => {
    ...
    const handleEnableEdit = function (jobId) {
    ...
    const handleUpdateJob = function (jobId) {
        const updatedJob = myJobs.find((job) => job._id === jobId);
        axios
            .put(`http://localhost:4000/api/v1/job/update/${jobId}`, updatedJob, { withCredentials: true })
            .then((res) => {
    ...
    const handleJobDelete = function (jobId) {
        axios
    ...
    const handleInputChange = function (jobId, field, value) {
